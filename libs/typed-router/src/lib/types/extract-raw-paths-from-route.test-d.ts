...
describe('ExtractRawPathsFromRoute', () => {
  ...
  it('structural parent without component not included, child included', () => {
    ...
    expectTypeOf<ExtractRawPathsFromRoute<typeof r>>().toEqualTypeOf<'parent/child'>();
  });
  ...
  it('parent with component AND child includes both parent and nested', () => {
    ...
    expectTypeOf<ExtractRawPathsFromRoute<typeof r>>().toEqualTypeOf<'p' | 'p/c'>();
  });
  ...
  it('nested deeper structure accumulates segments', () => {
    ...
    expectTypeOf<ExtractRawPathsFromRoute<typeof r>>().toEqualTypeOf<'a/b/c'>();
  });

  it('root empty path component yields empty string path', () => {
    const r = { path: '', component: C } as const satisfies Route;
    expectTypeOf<ExtractRawPathsFromRoute<typeof r>>().toEqualTypeOf<''>();
  });
  ...
  it('root empty structural path with child yields child path (no leading slash)', () => {
    ...
    expectTypeOf<ExtractRawPathsFromRoute<typeof r>>().toEqualTypeOf<'dash'>();
  });
  ...
  it('lazy child route paths are prefixed correctly', () => {
    ...
    expectTypeOf<ExtractRawPathsFromRoute<typeof r>>().toEqualTypeOf<'lazy/sub'>();
  });
  ...
  it('explicit prefix argument prepends to all derived paths', () => {
    const r = { path: 'home', component: C } as const satisfies Route;
    expectTypeOf<ExtractRawPathsFromRoute<typeof r, 'base'>>().toEqualTypeOf<'base/home'>();
  });

  it('explicit prefix with empty path child collapses correctly', () => {
    const r = { path: '', component: C } as const satisfies Route;
    expectTypeOf<ExtractRawPathsFromRoute<typeof r, 'base'>>().toEqualTypeOf<'base'>();
  });
  ...
  it('structural parent with prefix only yields descendant prefixed paths', () => {
    ...
    expectTypeOf<ExtractRawPathsFromRoute<typeof r, 'x'>>().toEqualTypeOf<'x/p/c'>();
  });

  it(':paramName segment preserved in raw form (no substitution here)', () => {
    const r = { path: 'user/:id', component: C } as const satisfies Route;
    expectTypeOf<ExtractRawPathsFromRoute<typeof r>>().toEqualTypeOf<'user/:id'>();
  });
