...
const routes = [
  ...
  { path: 'lazy', loadChildren: () => Promise.resolve(lazyChildren).then(m => m) },
  { path: 'redirect', redirectTo: 'home', pathMatch: 'full' },
  { path: 'struct', children: [ { path: 'leaf', component: C } ] },
  { path: 'user/:id', component: C },
] as const satisfies readonly Route[];

declare module './typed-routes' { interface UserTypedRoutes { routes: typeof routes; } }
declare module './types/replace-params' { interface AllowedRouteParamValues { id: '123' | '456'; } }
